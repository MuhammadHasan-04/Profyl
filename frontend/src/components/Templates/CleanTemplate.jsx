  ...
  return (
    <div className="p-10 bg-white w-full">
      ...
      <div className="py-10">
        ...
        <p className="font-serif leading-relaxed tracking-wide py-2 text-slate-800">
          {data.info.summary ||
        ...
        {data.projects.map((proj, index) => (
          <div key={index} className="py-5">
            <div className="flex justify-between">
              <h className="font-bold  text-xl">
                {proj.title || "Project Title"}
              </h>
              <p className="  font-light italic">
                {proj.link || "www.github.com/Profile/ProjectName"}
              </p>
            </div>

            <p className="font-serif leading-relaxed tracking-wide mt-7 text-slate-800">
              {proj.description ||
                "Brief description of the project and your role/impact..."}
            </p>
            <div className="flex gap-2">
              <p className="font-bold ">Technolog Stack : </p>
              <p className="font-serif leading-relaxed tracking-wid text-slate-800">
                {proj.tech || "(e.g. React, Node.js, MongoDB)"}
              </p>{" "}
            </div>
          </div>
        ))}
      ...
      <div className="py-5">
        ...
        <div className="py-5">
          ...
          <div className="flex font-serif leading-relaxed tracking-wide  text-slate-800 gap-2">
            <p className="font-bold">Development Tools & Practices :</p>
            <p className="">
